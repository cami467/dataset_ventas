# -*- coding: utf-8 -*-
"""Mistral_IA_agente.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/github/cami467/dataset_ventas/blob/master/Mistral_IA_agente.ipynb
...
agent_df = create_pandas_dataframe_agent(
    ...
    prefix="Responde únicamente con código Python, no des la respuesta final en texto.",
    verbose=True,
...
# Probar el agente
respuesta = agent_df.run("¿Cuál es el promedio de ventas por país?")
print(respuesta)
